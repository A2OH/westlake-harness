...
**50 of the 81 open gaps were touched on this path; 31 were not.**
...
| bionic libc ABI: 14 symbols to translate onto musl | missing | C1/C2 | S | yes | OH musl libc | bionic-ABI shim: forward or translate; never ship a second libc<br>open: __get_h_errno, __pthread_cleanup_pop, __pthread_cleanup_push, __sF, __system_property_find_nth, __system_property_foreach, __system_property_read, isinf |
